...
const Tab = (props) => {
    ...
    <Link to={`/restaurant/${id}/${props.route}`}>
        ...
        <div className={classnames("text-gray-500 relative  font-light", 
                                    {"text-zomato-400 font-light" : props.isActive,
                                     })
                                    }>

                <div className="absolute h-2 w-full border-t-2 border-zomato-400 top-10"/>
...
const TabContainer = (props) => {
    ...
    return <>
        <div className="flex pb-4 relative items-center gap-8 md:gap-20 overflow-x-scroll border-b-2">
           {tabs.map((tab) => (
