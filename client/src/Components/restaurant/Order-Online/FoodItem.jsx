      ...
      {food?.name && (
        <div className="flex items-start gap-2 ">
          ...
          <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className=" md:hidden flex items-center gap-2 text-foodstar-400 bg-foodstar-50 border border-foodstar-400 px-2 py-1 rounded-lg"
              >
                {food.isAddedToCart ? (
                  "Added"
                ) : (
          ...
          <button
              onClick={addFoodToCart}
              disabled={food.isAddedToCart}
              className=" flex items-center gap-2 text-foodstar-400 bg-foodstar-50 border border-foodstar-400 px-4 py-2 rounded-lg"
            >
              {food.isAddedToCart ? (
                "Added"
              ) : (
